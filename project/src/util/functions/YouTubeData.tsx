...
import { getVideoTime, setVideoTime } from "@/screens/Player/YouTubePlayer/YouTubePlayer";
...
export const timeStampInjection = (currentTheme: ThemeType, message: string) => {
    ...
    if (match) {
      ...
      return (
        <button
          ...
          style={{backgroundColor: appTheme[currentTheme].bot_time_stamp, color: appTheme[currentTheme].text_2}}
